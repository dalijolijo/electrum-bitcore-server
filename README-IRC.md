...
current list can be seen by running:
    ...
    electrum-creditbit-server peers
...
`electrum-creditbit-server peers` will always return an empty list.
...
composing the IRC nickname to identify your server on #electrum-creditbit.
